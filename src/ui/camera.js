...
class Camera extends Evented {
     ...
     */
    panBy(offset: PointLike, options?: AnimationOptions, eventData?: Object, callback?: Function) {
        offset = Point.convert(offset).mult(-1);
        return this.panTo(this.transform.center, util.extend({offset}, options), eventData, callback);
    }
     ...
     * @returns {Map} `this`
     */
    panTo(lnglat: LngLatLike, options?: AnimationOptions, eventData?: Object, callback?: Function) {
     ...
     * @returns {Map} `this`
     */
    zoomTo(zoom: number, options: ? AnimationOptions, eventData?: Object, callback?: Function) {
        return this.easeTo(util.extend({
            zoom: zoom
        }, options), eventData, callback);
    }
     ...
     * @returns {Map} `this`
     */
    rotateTo(bearing: number, options?: AnimationOptions, eventData?: Object, callback?: Function) {
        return this.easeTo(util.extend({
            bearing: bearing
        }, options), eventData, callback);
    }
     ...
     * @see [Navigate the map with game-like controls](https://www.mapbox.com/mapbox-gl-js/example/game-controls/)
     */
    easeTo(options: CameraOptions & AnimationOptions & {delayEndEvents?: number}, eventData?: Object, callback?: Function) {
        this.stop();
     ...
     */
    flyTo(options, eventData?: Object, callback?: Function) {
        ...
        if (Math.abs(u1) < 0.000001 || isNaN(S)) {
            ...
            if (Math.abs(w0 - w1) < 0.000001) return this.easeTo(options, eventData, callback);
