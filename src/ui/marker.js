...
function genUpdateFn(_this) {
    return function(e?: {type: 'move' | 'moveend'}) {
        requestAnimationFrame(function() { if (_this._map) {
            if (_this._map.transform.renderWorldCopies) {
                _this._lngLat = smartWrap(_this._lngLat, _this._pos, _this._map.transform);
            }

            _this._pos = _this._map.project(_this._lngLat)._add(_this._offset);
